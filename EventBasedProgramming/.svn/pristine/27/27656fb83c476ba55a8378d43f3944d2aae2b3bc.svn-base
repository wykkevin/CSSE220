...
public class BreakfastMain {
	...
	public void createWindows() {
		...
		ButtonListener1 myListener1=new ButtonListener1(eatButton);
		JButton eatButton2 = new JButton("Eat Porridge2");
		JPanel mypanel=new JPanel();
		//ActionListener foo=new ButtonListener2();
		eatButton.addActionListener(myListener1);
		eatButton2.addActionListener(new ActionListener(){

			@Override
			public void actionPerformed(ActionEvent e) {
				System.out.println("agggfd");
				
			}
			
		});
		mypanel.add(eatButton);
		mypanel.add(eatButton2);
		frame.add(mypanel);
