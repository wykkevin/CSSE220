...
public class BettingMain {
	...
	private ArrayList<HighBet> highBets;
	private ArrayList<Betable> bets;
	...
	public BettingMain() {
		...
		this.highBets = new ArrayList<HighBet>();
		this.bets=new ArrayList<Betable>();
	}
