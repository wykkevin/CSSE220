...
public class RecursionPractice {
	...
	public static String weirdoString(String stringInput) {
		...
		if (stringInput.charAt(0) == 'a' || stringInput.charAt(0) == 'b') {
			return weirdoString(stringInput.substring(1, stringInput.length()));
		}
		if (stringInput.charAt(0) == 'C') {
			return "QQQ" + weirdoString(stringInput.substring(1, stringInput.length()));
		}
		newString += stringInput.substring(0, 1);
		return newString + weirdoString(stringInput.substring(1, stringInput.length()));
	}
	...
	public static boolean evenPowerOfThree(int inputValue) {
		if (inputValue == 1) {
			return true;
		} else if (inputValue < 1 || (inputValue > 1 && inputValue < 9)) {
			return false;
		}
	...
	public static boolean numbersGame(int startingNumber) {
		...
		if (startingNumber % 3 == 0 && (startingNumber % 7) != 1) {
