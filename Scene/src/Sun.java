...
public class Sun {
	...
	public void drawOn(Graphics2D g4) {
		...
		g4.translate(this.x + this.circleDiameter / 2, this.y + this.circleDiameter / 2);
	...
	public void drawRay(Graphics2D g4, double angle) {
		Rectangle2D.Double rayRec = new Rectangle2D.Double(0,
				(-this.circleDiameter * (RAY_LENGTH_SCALE + RAY_DISTANCE_FROM_SUN_SCALE + 0.5)),
				(this.circleDiameter * RAY_WIDTH_SCALE), (this.circleDiameter * RAY_LENGTH_SCALE));
		g4.setColor(BORDER_COLOR);
		g4.draw(rayRec);
		g4.setColor(this.color);
		g4.fill(rayRec);
