...
public class LinkedListTest {
	...
	public void testSet() {
		...
		assertEquals(new Integer(3), this.list1.get(2));
		assertEquals(new Integer(5), this.list1.get(4));
		assertEquals(6, this.list1.size());
	}
	...
	public void testIterator() {
		...
		this.list2.add(5);
		this.list2.add(6);
		Iterator<Integer> itr = this.list2.iterator();
		...
		// skipping call to hasNext() because that is allowed
		assertEquals((Integer) 4, itr.next());
		assertTrue(itr.hasNext());
		assertEquals((Integer) 5, itr.next());
		assertTrue(itr.hasNext());
		assertEquals((Integer) 6, itr.next());
		assertFalse(itr.hasNext());
		
		this.list1.add(2);
		this.list1.add(6);
		this.list1.add(7);
		itr = this.list1.iterator();
